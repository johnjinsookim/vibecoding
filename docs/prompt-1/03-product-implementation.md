...
- `docs/prompt-1/02-product-requirements.md`
...
Read `docs/prompt-1/02-product-requirements.md` and extract:
...
- `prototype/prompt-1/src/features/evaluator-builder/`
  - `core/` (pure logic)
  - `ui/` (components)
  - `index.*` (exports)

Tests (if applicable):
- `prototype/prompt-1/src/*.test.mjs`
...
- Where to navigate
- Add to a README.md file that also gives an executive summary of what the product does
